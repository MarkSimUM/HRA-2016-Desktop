...
uses
  Classes, SysUtils, db, pqconnection, FileUtil, Ora, OdacVcl, paswstring,
  DBAccess, MemDataSet;
...
type
  ...
  TDM_Main = class(TDataModule)
    ...
    dataAccountACCOUNTNAMEID: TStringField;
    ...
    dataOrganizationCHKFLD: TStringField;
    ...
    dataOrganizationORGNAMEID: TStringField;
